...
export const initialIngredients: Ingredient[] = [
  ...
  { id: 'ing_soda', nomi: "Iste'mol sodasi", kategoriya: 'ziravor', icon: '🧂' },
  { id: 'ing_razraxlitel', nomi: 'Xamir yumshatgich (Razraxlitel)', kategoriya: 'ziravor', icon: '🧂' },
  { id: 'ing_vanilin', nomi: 'Vanilin', kategoriya: 'ziravor', icon: '🧁' },
  ...
  { id: 'ing_paxta_yogi', nomi: "Paxta yog'i", kategoriya: 'boshqa', icon: '🍾' },
  { id: 'ing_osimlik_yogi', nomi: "Kungaboqar yog'i", kategoriya: 'boshqa', icon: '🍾' },
  { id: 'ing_makkajoxori_yogi', nomi: "Makkajo'xori yog'i", kategoriya: 'boshqa', icon: '🍾' },
  { id: 'ing_zaytun_yogi', nomi: "Zaytun yog'i", kategoriya: 'boshqa', icon: '🫒' },
  { id: 'ing_kunjut_yogi', nomi: "Kunjut yog'i", kategoriya: 'boshqa', icon: '🍾' },
  { id: 'ing_tomat', nomi: 'Tomat pastasi', kategoriya: 'boshqa', icon: '🥫' },
  ...
  { id: 'ing_shakar', nomi: 'Shakar', kategoriya: 'boshqa', icon: '🍬' },
  { id: 'ing_qand', nomi: 'Qand', kategoriya: 'boshqa', icon: '🧊' },
  { id: 'ing_sirka', nomi: 'Uzum sirkasi', kategoriya: 'boshqa', icon: '🧪' },
  { id: 'ing_olma_sirkasi', nomi: 'Olma sirkasi', kategoriya: 'boshqa', icon: '🍎' },
  { id: 'ing_limon', nomi: 'Limon', kategoriya: 'boshqa', icon: '🍋' },
